...
- [`HMDB_mapper_vec`](https://saezlab.github.io/cosmosR/reference/HMDB_mapper_vec.md)
...
- [`cosmos_data()`](https://saezlab.github.io/cosmosR/reference/cosmos_data.md)
  : Create Cosmos Data
- [`createLinearColors()`](https://saezlab.github.io/cosmosR/reference/createLinearColors.md)
...
- [`decompress_solution_network()`](https://saezlab.github.io/cosmosR/reference/decompress_solution_network.md)
...
- [`gmt_to_dataframe()`](https://saezlab.github.io/cosmosR/reference/gmt_to_dataframe.md)
...
- [`make_heatmap_color_palette()`](https://saezlab.github.io/cosmosR/reference/make_heatmap_color_palette.md)
...
- [`moon()`](https://saezlab.github.io/cosmosR/reference/moon.md) : moon
...
- [`print(`*`<cosmos_data>`*`)`](https://saezlab.github.io/cosmosR/reference/print.cosmos_data.md)
...
- [`toy_RNA`](https://saezlab.github.io/cosmosR/reference/toy_RNA.md) :
  Toy Input Transcription Data Set
- [`toy_metabolic_input`](https://saezlab.github.io/cosmosR/reference/toy_metabolic_input.md)
  : Toy Metabolic Input Data
- [`toy_network`](https://saezlab.github.io/cosmosR/reference/toy_network.md)
  : Toy Input Network
- [`toy_signaling_input`](https://saezlab.github.io/cosmosR/reference/toy_signaling_input.md)
  : Toy Signaling Input
