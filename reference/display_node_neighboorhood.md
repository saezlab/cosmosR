...
#> 13:51:06 28.07.2026 Carnival flavour: vanilla
#> 13:51:06 28.07.2026 Generating variables for lp problem
#> 13:51:06 28.07.2026 Done: generating variables for lp problem
#> Saving preprocessed data.
#> Done: saving parsed data: /__w/cosmosR/cosmosR/docs/reference//parsedData_t13_51_06d28_07_2026n45.RData
#> 13:51:06 28.07.2026 Generating formulation for LP problem
#> 13:51:06 28.07.2026 Done: generating formulation for LP problem.
#> Saving LP file
#> Done: Saving LP file: /__w/cosmosR/cosmosR/docs/reference//lpFile_t13_51_06d28_07_2026n45.lp
#> 13:51:07 28.07.2026 Solving LP problem
...
#> 13:51:07 28.07.2026 Done: solving LP problem.
#> 13:51:07 28.07.2026 Getting the solution matrix
#> 13:51:07 28.07.2026 Done: getting the solution matrix.
#> 13:51:07 28.07.2026 Exporting solution matrix
#> 13:51:07 28.07.2026 Done: exporting solution matrix.
#> Cleaning intermediate files
#> Done: cleaning
#> 13:51:07 28.07.2026 All tasks finished.
#> 
...
#> [1] "lpSolve does not scale well with large PKNs. This solver is mainly for testing purposes. To run COSMSO, we recommend using cplex, or cbc solvers."
#> --- Start of the CARNIVAL pipeline ---
#> 13:51:07 28.07.2026 Carnival flavour: vanilla
#> 13:51:07 28.07.2026 Generating variables for lp problem
#> 13:51:07 28.07.2026 Done: generating variables for lp problem
#> Saving preprocessed data.
#> Done: saving parsed data: /__w/cosmosR/cosmosR/docs/reference//parsedData_t13_51_07d28_07_2026n23.RData
#> 13:51:07 28.07.2026 Generating formulation for LP problem
#> 13:51:07 28.07.2026 Done: generating formulation for LP problem.
#> Saving LP file
#> Done: Saving LP file: /__w/cosmosR/cosmosR/docs/reference//lpFile_t13_51_07d28_07_2026n23.lp
#> 13:51:07 28.07.2026 Solving LP problem
#> Parsing .lp file for lpSolve
#> Rows: 882 Columns: 1
#> ── Column specification ────────────────────────────────────────────────────────
...
#> ℹ Specify the column types or set `show_col_types = FALSE` to quiet this message.
#> Done: parsing .lp file for lpSolve
#> 13:51:08 28.07.2026 Done: solving LP problem.
#> 13:51:08 28.07.2026 Getting the solution matrix
#> 13:51:08 28.07.2026 Done: getting the solution matrix.
#> 13:51:08 28.07.2026 Exporting solution matrix
#> 13:51:08 28.07.2026 Done: exporting solution matrix.
#> Cleaning intermediate files
#> Done: cleaning
#> 13:51:08 28.07.2026 All tasks finished.
#> 
#> --- End of the CARNIVAL pipeline --- 
