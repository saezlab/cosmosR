...
#> 14:14:27 12.03.2026 Carnival flavour: vanilla
#> 14:14:27 12.03.2026 Generating variables for lp problem
#> 14:14:27 12.03.2026 Done: generating variables for lp problem
#> Saving preprocessed data.
#> Done: saving parsed data: /__w/cosmosR/cosmosR/docs/reference//parsedData_t14_14_27d12_03_2026n45.RData
#> 14:14:27 12.03.2026 Generating formulation for LP problem
#> 14:14:27 12.03.2026 Done: generating formulation for LP problem.
#> Saving LP file
#> Done: Saving LP file: /__w/cosmosR/cosmosR/docs/reference//lpFile_t14_14_27d12_03_2026n45.lp
#> 14:14:27 12.03.2026 Solving LP problem
...
#> 14:14:27 12.03.2026 Done: solving LP problem.
#> 14:14:27 12.03.2026 Getting the solution matrix
#> 14:14:27 12.03.2026 Done: getting the solution matrix.
#> 14:14:27 12.03.2026 Exporting solution matrix
#> 14:14:27 12.03.2026 Done: exporting solution matrix.
#> Cleaning intermediate files
#> Done: cleaning
#> 14:14:27 12.03.2026 All tasks finished.
#> 
...
#> 14:14:27 12.03.2026 Done: generating variables for lp problem
#> Saving preprocessed data.
#> Done: saving parsed data: /__w/cosmosR/cosmosR/docs/reference//parsedData_t14_14_27d12_03_2026n23.RData
#> 14:14:27 12.03.2026 Generating formulation for LP problem
#> 14:14:27 12.03.2026 Done: generating formulation for LP problem.
#> Saving LP file
#> Done: Saving LP file: /__w/cosmosR/cosmosR/docs/reference//lpFile_t14_14_27d12_03_2026n23.lp
#> 14:14:27 12.03.2026 Solving LP problem
#> Parsing .lp file for lpSolve
#> Rows: 882 Columns: 1
#> ── Column specification ────────────────────────────────────────────────────────
...
#> ℹ Specify the column types or set `show_col_types = FALSE` to quiet this message.
#> Done: parsing .lp file for lpSolve
#> 14:14:28 12.03.2026 Done: solving LP problem.
#> 14:14:28 12.03.2026 Getting the solution matrix
#> 14:14:28 12.03.2026 Done: getting the solution matrix.
#> 14:14:28 12.03.2026 Exporting solution matrix
#> 14:14:28 12.03.2026 Done: exporting solution matrix.
#> Cleaning intermediate files
#> Done: cleaning
#> 14:14:28 12.03.2026 All tasks finished.
#> 
#> --- End of the CARNIVAL pipeline --- 
