...
#> 14:17:16 12.03.2026 Carnival flavour: vanilla
#> 14:17:16 12.03.2026 Generating variables for lp problem
#> 14:17:16 12.03.2026 Done: generating variables for lp problem
#> Saving preprocessed data.
#> Done: saving parsed data: /__w/cosmosR/cosmosR/docs/reference//parsedData_t14_17_16d12_03_2026n69.RData
#> 14:17:16 12.03.2026 Generating formulation for LP problem
#> 14:17:16 12.03.2026 Done: generating formulation for LP problem.
#> Saving LP file
#> Done: Saving LP file: /__w/cosmosR/cosmosR/docs/reference//lpFile_t14_17_16d12_03_2026n69.lp
#> 14:17:16 12.03.2026 Solving LP problem
...
#> 14:17:17 12.03.2026 Done: solving LP problem.
#> 14:17:17 12.03.2026 Getting the solution matrix
#> 14:17:17 12.03.2026 Done: getting the solution matrix.
#> 14:17:17 12.03.2026 Exporting solution matrix
#> 14:17:17 12.03.2026 Done: exporting solution matrix.
#> Cleaning intermediate files
#> Done: cleaning
#> 14:17:17 12.03.2026 All tasks finished.
#> 
...
#> [1] "lpSolve does not scale well with large PKNs. This solver is mainly for testing purposes. To run COSMSO, we recommend using cplex, or cbc solvers."
#> --- Start of the CARNIVAL pipeline ---
#> 14:17:17 12.03.2026 Carnival flavour: vanilla
#> 14:17:17 12.03.2026 Generating variables for lp problem
#> 14:17:17 12.03.2026 Done: generating variables for lp problem
#> Saving preprocessed data.
#> Done: saving parsed data: /__w/cosmosR/cosmosR/docs/reference//parsedData_t14_17_17d12_03_2026n5.RData
#> 14:17:17 12.03.2026 Generating formulation for LP problem
#> 14:17:17 12.03.2026 Done: generating formulation for LP problem.
#> Saving LP file
#> Done: Saving LP file: /__w/cosmosR/cosmosR/docs/reference//lpFile_t14_17_17d12_03_2026n5.lp
#> 14:17:17 12.03.2026 Solving LP problem
#> Parsing .lp file for lpSolve
#> Rows: 882 Columns: 1
#> ── Column specification ────────────────────────────────────────────────────────
#> Delimiter: ","
...
#> 14:17:17 12.03.2026 Done: getting the solution matrix.
#> 14:17:17 12.03.2026 Exporting solution matrix
#> 14:17:18 12.03.2026 Done: exporting solution matrix.
#> Cleaning intermediate files
#> Done: cleaning
#> 14:17:18 12.03.2026 All tasks finished.
#> 
#> --- End of the CARNIVAL pipeline --- 
```
