...
```
    ...
    ## [22] rlang_1.2.0         decoupleR_2.10.0    crayon_1.5.3       
    ## [25] visNetwork_2.1.4    parallelly_1.47.0   bit64_4.8.2        
    ...
    ## [49] pillar_1.11.1       bslib_0.11.0        glue_1.8.1         
    ## [52] systemfonts_1.3.2   xfun_0.58           tibble_3.3.1       
    ## [55] tidyselect_1.2.1    knitr_1.51          CARNIVAL_2.14.0    
    ## [58] dorothea_1.16.0     rjson_0.2.23        htmltools_0.5.9    
    ## [61] igraph_2.3.2        rmarkdown_2.31      readr_2.2.0        
