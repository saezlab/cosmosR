...
preprocess_COSMOS_metabolism_to_signaling <- function(meta_network = load_meta_pkn(),
    ...
    out_data <- preprocess_COSMOS_core(meta_network = meta_network,
                           ...
                           input_layer = "metabolic_data",
                           output_layer = "signaling_data",
    ...
    out_data$history  = c(out_data$history,"created by preprocess_COSMOS_metabolism_to_signaling\n")
