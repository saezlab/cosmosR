...
(e.g. cancer vs. normal tissue, or treatment vs. normal cells) can be shown.
...
nodes_cosmos = extractCOSMOSnodes(cosmos_result)

# can be deleted later on
nodes_bg <- c("PNP", "ACAA1", "ACO1", "Cis_Aconitate_m_", "Uridine_l_", "ADA",
              "Inosine_e_", "AGER", "CSNK2A2", "DBF4B", "PIK3CA", "SMAD4", "AHCY",
              "AKT3", "ESR1", "GATA2", "SMAD3", "SRPK2", "BTK", "CDK9", "MAPK8")
nodes_cosmos$bg <- append(nodes_cosmos$bg,nodes_bg)

# The gene set analysis (GSA) is based on a list of significant genes
# (CARNIVAL nodes) and a gene set collection (background). 
...
plot_pathways = plotPathways(sig_pathways_df)
plot_pathways2 = plotPathways2(sig_pathways_df)
```
...
pathways_interesting <- c("KEGG_PANTOTHENATE_AND_COA_BIOSYNTHESIS", "BIOCARTA_CDMAC_PATHWAY",
                          "REACTOME_ANTI_INFLAMMATORY_RESPONSE_FAVOURING_LEISHMANIA_PARASITE_INFECTION")

nodes_att_pathways <- highlightPathways(pathwaysMSigDB = pathways,
