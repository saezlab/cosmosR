...
We can use the result from the ORA and map to every node in the solution network
the most significant pathway. 
The user has to define a set of interesting pathways which should be highlighted.

```{r, warning=FALSE, message=FALSE}
source("C:/Users/Admin/Documents/MASTER/4Semester/Internship_1_Saez-Rodriguez/Project_2_Highlight_interesting_pathways/OCEAN/cosmosR/R/highlight_pathways.R")

#' - Look at result of ORA ("results/top_pathways.png") and select most significant pathways
...
pathways_interesting <- c("KEGG_PANTOTHENATE_AND_COA_BIOSYNTHESIS",
                          "BIOCARTA_CDMAC_PATHWAY",
                          "REACTOME_ANTI_INFLAMMATORY_RESPONSE_FAVOURING_LEISHMANIA_PARASITE_INFECTION")

##Choose "p-value" or "Adjusted p-value" as filterMethod
